    ...
    <section className="sobre" id="sobre">
      <div className="container sobre__content">
        <div className="sobre__text">
          <h2>Sobre</h2>
          <p>
            O <strong>Studio Larissa Paes</strong>, nasceu com o propósito de valorizar a beleza única de cada pessoa.
💖 Aqui, cada atendimento é feito com carinho e dedicação.
...
💋 Também realizo tratamentos como hidratação labial, que trazem ainda mais naturalidade e sofisticação ao seu visual.
          ...
          <p>
            O espaço foi criado para ser aconchegante, garantindo uma experiência acolhedora e especial.
